...
const AsyncSettingComponent = Loadable({
	loader: () => import("Container/SettingContainer"),
	loading: () => <RctPageLoader />,
});

const AsyncBookingListComponent = Loadable({
	loader: () => import("Container/BookingListContainer"),
	loading: () => <RctPageLoader />,
});
...
const AsyncClientComponent = Loadable({
	loader: () => import("Container/ClientContactContainer"),
	loading: () => <RctPageLoader />,
});
